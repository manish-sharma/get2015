...
<link rel="styleSheet" href="/CaseStudyPhase4/CSS/SearchStyle.css">
<script src="javaScript/Search.js"></script>
</head>
<body>
	<div class="wrapper">
		<header>
			<img src="/CaseStudyPhase4/images/logo.png" alt="car dekho logo" width="400px"
   ...
   <form action="/CaseStudyPhase4/AdminSearchController" method="post">
	    <div class="heading">
	   <h2>Search</h2>
