...
public class CarDBHelper extends VehicleDBHelper {
	...
	public boolean create(Connection connection, Car car) throws CarDekhoSystemException {
	...
	public boolean update(Connection connection,Car car) throws CarDekhoSystemException {
	...
	public Vehicle getCarByVehicleId(Connection connection,int vehicleID)
		...
		if (connection != null) {
			...
			try {
				...
				throw new CarDekhoSystemException(
						"Could not find Vehicle by Id, [" + e.getMessage()
								+ "]");
			}
		}
		return vehicle;
