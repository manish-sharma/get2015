...
public class WriteVehicleXml {
	 ...
	 * @return
	 */
	public void saveConfigCar(String make, String model, String engineInCC,
			String fuelCapacity, String milage, String price, String roadTax,
	 ...
	 * @return
	 */
	public void saveConfigBike(String make, String model, String engineInCC,
			String fuelCapacity, String milage, String price, String roadTax,
			String selfStart, String helmetPrice) throws Exception {
		java.util.Date date = new java.util.Date();
		// create an XMLOutputFactory
		XMLOutputFactory outputFactory = XMLOutputFactory.newInstance();
		// create XMLEventWriter
		...
		StartElement configStartElementNewVehicle = eventFactory
				.createStartElement("", "", VehicleTypes.Bike.toString());
		eventWriter.add(configStartElementNewVehicle);
		eventWriter.add(end);
		...
		createNode(eventWriter, VehicleAttributes.selfStart.toString(),
				selfStart);
