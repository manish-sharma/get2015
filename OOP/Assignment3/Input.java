...
public class Input {
	...
	public void passengerDetailsFromUser(){
		...
		System.out.println("enter the train number in which you wan't to reserve the seat");
		...
		if(isAvailable){
			...
			boolean status = payment.doPayment(trainNumberUser,numberOfSeat,fare);
			if(status){
	...
	public void goodsDetailFromUser(){
		...
		System.out.println("enter the train number in which you wan't to reserve the load");
		int trainNumberUser=userInput();
		...
		if(isAvailable){
			...
			boolean status = payment.doPayment(trainNumberUser,loadWeight,fare);
			if(status){
	...
	public void startReservation(){
		...
		if(trainType.equalsIgnoreCase("passenger")){
			...
			Passenger.refineTrainsList=passenger.refineTrains(source, destination);
