...
/**
 * It is the main class handling all classes and managing service station
 * 
 * @author Arushi
 * 
 */
public class ServiceStation {
	...
	public static void main(String[] args) {
		...
		// for Mechanic
		File file = new File(
				"E:/My-Desktop/workspace/TrainingEx/src/ServiceCar/Storage.txt");
		try {
			...
			System.out.println("Enter entry for each mechanic in form:::-Mechanic_Name,Car specialization,Cost of mechanic for service");
			...
			File file1 = new File(
					"E:/My-Desktop/workspace/TrainingEx/src/ServiceCar/Cars.txt");
			...
			System.out.println("Enter total no of cars which come for service today");
			int n1 = scanner.nextInt();
			System.out.println("Enter entry of each car in format::car id,car type");
