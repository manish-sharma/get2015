...
public class Survey {
	public static void main(String args[])
	{
		...
		switch(ch)
		{
		case 1:count=count+1;  //To ask survey questions from user
			   ...
			   break;
		case 2:for(i=1;i<=count;i++)  //To display single select answer statistics
			   {
				...
				break;
		case 3: for(i=1;i<=count;i++)  //To display all participant information
			    {
