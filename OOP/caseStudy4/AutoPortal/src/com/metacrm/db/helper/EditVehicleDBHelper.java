...
public class EditVehicleDBHelper {
    ...
    protected int create(Connection connection, Vehicle objVehicle, String oldMake, String oldModel ) throws MetaCRMSystemException {
		...
		try {
			...
			throw new MetaCRMSystemException("Could not update Vehicle, [" + e.getMessage() + "]");
		} finally {
    ...
    protected int getVehicleIdByMakeModel(Connection connection, String oldMake, String oldModel) throws MetaCRMSystemException {
		int vehicleId = -1;
		if(connection != null) {
			PreparedStatement preparedStatement = null;
