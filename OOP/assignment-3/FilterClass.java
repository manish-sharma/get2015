...
{    
	 ...
	 **/
	public static List<String> intialFilter(String name,String type) throws IOException
	{
		// Inputed list
	 ...
	 **/
	public static List<String> secondFilter(List<String> secondInput,String source, String destination)
	{
		// list array
		...
		for(int count=0;count<getList4.size();count++)
		{
			...
			if (tokens.length > 0) 
			{
				...
				if(tokens[1].equalsIgnoreCase(source) && tokens[2].equalsIgnoreCase(destination)) 
				{
					...
					System.out.println(secondInput.get(count));
				}
		     }
		}
	return getList1;
	 ...
	 */
	public static List<String> thirdFilter(List<String> thirdInput,String trainName, int noOfPassengers) throws IOException
	{
