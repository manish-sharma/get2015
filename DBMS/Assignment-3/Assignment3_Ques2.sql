...
b1.due_dt,FLOOR(DATEDIFF(b1.due_dt,b1.issue_dt)/30) AS Months FROM members m1 
JOIN book_issue b1 ON m1.member_id = b1.member_id JOIN books b2 ON 
b1.accession_no = b2.accession_no JOIN titles t1
