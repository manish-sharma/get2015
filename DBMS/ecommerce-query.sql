...
from
    categories as node
        left outer join
    categories as parent1 ON parent1.id = node.parentid
        left outer join
    categories as parent2 ON parent2.id = parent1.parentid
        left outer join
    categories as parent3 ON parent3.id = parent2.parentid;
