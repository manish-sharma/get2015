...
public class DescribeGlobalResponse  implements java.io.Serializable {
    private com.sforce.soap.enterprise.DescribeGlobalResult result;

    public DescribeGlobalResponse() {
    }

    public DescribeGlobalResponse(
           com.sforce.soap.enterprise.DescribeGlobalResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.sforce.soap.enterprise.DescribeGlobalResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.sforce.soap.enterprise.DescribeGlobalResult result) {
        this.result = result;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", ">describeGlobalResponse"));
