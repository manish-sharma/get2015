...
public class SearchResponse  implements java.io.Serializable {
    ...
    public SearchResponse(
           com.sforce.soap.enterprise.SearchResult result) {
           this.result = result;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", ">searchResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("result");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "result"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "SearchResult"));
