...
public class DescribeCompactLayoutsResult  implements java.io.Serializable {
    private com.sforce.soap.enterprise.DescribeCompactLayout[] compactLayouts;

    private java.lang.String defaultCompactLayoutId;

    private com.sforce.soap.enterprise.RecordTypeCompactLayoutMapping[] recordTypeCompactLayoutMappings;

    public DescribeCompactLayoutsResult() {
    }

    public DescribeCompactLayoutsResult(
           com.sforce.soap.enterprise.DescribeCompactLayout[] compactLayouts,
           java.lang.String defaultCompactLayoutId,
           com.sforce.soap.enterprise.RecordTypeCompactLayoutMapping[] recordTypeCompactLayoutMappings) {
    ...
    public com.sforce.soap.enterprise.DescribeCompactLayout getCompactLayouts(int i) {
        return this.compactLayouts[i];
    }

    public void setCompactLayouts(int i, com.sforce.soap.enterprise.DescribeCompactLayout _value) {
    ...
    public com.sforce.soap.enterprise.RecordTypeCompactLayoutMapping getRecordTypeCompactLayoutMappings(int i) {
        return this.recordTypeCompactLayoutMappings[i];
    }

    public void setRecordTypeCompactLayoutMappings(int i, com.sforce.soap.enterprise.RecordTypeCompactLayoutMapping _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeCompactLayoutsResult"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("compactLayouts");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "compactLayouts"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeCompactLayout"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("defaultCompactLayoutId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "defaultCompactLayoutId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("recordTypeCompactLayoutMappings");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "recordTypeCompactLayoutMappings"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "RecordTypeCompactLayoutMapping"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
    }
