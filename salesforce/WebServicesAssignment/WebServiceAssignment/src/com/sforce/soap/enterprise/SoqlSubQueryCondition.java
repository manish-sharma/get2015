...
public class SoqlSubQueryCondition  extends com.sforce.soap.enterprise.SoqlWhereCondition  implements java.io.Serializable {
    ...
    public SoqlSubQueryCondition(
           ...
           com.sforce.soap.enterprise.SoqlOperator operator,
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "SoqlSubQueryCondition"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "operator"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "soqlOperator"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("subQuery");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "subQuery"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
