...
public class DescribeFlexiPageRegion  implements java.io.Serializable {
    private com.sforce.soap.enterprise.DescribeComponentInstance[] components;
    ...
    public DescribeFlexiPageRegion(
           com.sforce.soap.enterprise.DescribeComponentInstance[] components,
    ...
    public com.sforce.soap.enterprise.DescribeComponentInstance getComponents(int i) {
        return this.components[i];
    }

    public void setComponents(int i, com.sforce.soap.enterprise.DescribeComponentInstance _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeFlexiPageRegion"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeComponentInstance"));
