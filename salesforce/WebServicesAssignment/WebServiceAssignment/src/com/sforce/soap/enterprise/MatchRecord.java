...
public class MatchRecord  implements java.io.Serializable {
    private com.sforce.soap.enterprise.AdditionalInformationMap[] additionalInformation;

    private com.sforce.soap.enterprise.FieldDiff[] fieldDiffs;
    ...
    public MatchRecord(
           com.sforce.soap.enterprise.AdditionalInformationMap[] additionalInformation,
           com.sforce.soap.enterprise.FieldDiff[] fieldDiffs,
           double matchConfidence,
           com.sforce.soap.enterprise.sobject.SObject record) {
    ...
    public com.sforce.soap.enterprise.AdditionalInformationMap getAdditionalInformation(int i) {
        return this.additionalInformation[i];
    }

    public void setAdditionalInformation(int i, com.sforce.soap.enterprise.AdditionalInformationMap _value) {
    ...
    public com.sforce.soap.enterprise.FieldDiff getFieldDiffs(int i) {
        return this.fieldDiffs[i];
    }

    public void setFieldDiffs(int i, com.sforce.soap.enterprise.FieldDiff _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "MatchRecord"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("additionalInformation");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "additionalInformation"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "AdditionalInformationMap"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "fieldDiffs"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "FieldDiff"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "matchConfidence"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "double"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("record");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "record"));
