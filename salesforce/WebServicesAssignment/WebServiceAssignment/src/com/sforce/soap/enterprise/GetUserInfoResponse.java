...
public class GetUserInfoResponse  implements java.io.Serializable {
    private com.sforce.soap.enterprise.GetUserInfoResult result;

    public GetUserInfoResponse() {
    }

    public GetUserInfoResponse(
           com.sforce.soap.enterprise.GetUserInfoResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.sforce.soap.enterprise.GetUserInfoResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.sforce.soap.enterprise.GetUserInfoResult result) {
        this.result = result;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", ">getUserInfoResponse"));
