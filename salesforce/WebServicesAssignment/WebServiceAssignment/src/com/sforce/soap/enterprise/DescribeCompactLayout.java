...
public class DescribeCompactLayout  implements java.io.Serializable {
    private com.sforce.soap.enterprise.DescribeLayoutButton[] actions;

    private com.sforce.soap.enterprise.DescribeLayoutItem[] fieldItems;

    private java.lang.String id;

    private com.sforce.soap.enterprise.DescribeLayoutItem[] imageItems;
    ...
    public DescribeCompactLayout(
           com.sforce.soap.enterprise.DescribeLayoutButton[] actions,
           com.sforce.soap.enterprise.DescribeLayoutItem[] fieldItems,
           java.lang.String id,
           com.sforce.soap.enterprise.DescribeLayoutItem[] imageItems,
    ...
    public com.sforce.soap.enterprise.DescribeLayoutButton getActions(int i) {
        return this.actions[i];
    }

    public void setActions(int i, com.sforce.soap.enterprise.DescribeLayoutButton _value) {
    ...
    public com.sforce.soap.enterprise.DescribeLayoutItem getFieldItems(int i) {
        return this.fieldItems[i];
    }

    public void setFieldItems(int i, com.sforce.soap.enterprise.DescribeLayoutItem _value) {
    ...
    public com.sforce.soap.enterprise.DescribeLayoutItem getImageItems(int i) {
        return this.imageItems[i];
    }

    public void setImageItems(int i, com.sforce.soap.enterprise.DescribeLayoutItem _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeCompactLayout"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("actions");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "actions"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "fieldItems"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeLayoutItem"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "imageItems"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeLayoutItem"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "objectType"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
