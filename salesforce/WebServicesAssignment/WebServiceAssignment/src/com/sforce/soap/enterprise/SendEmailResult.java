...
public class SendEmailResult  implements java.io.Serializable {
    private com.sforce.soap.enterprise.SendEmailError[] errors;
    ...
    public SendEmailResult(
           com.sforce.soap.enterprise.SendEmailError[] errors,
           boolean success) {
           this.errors = errors;
     ...
     * @return errors
     */
    public com.sforce.soap.enterprise.SendEmailError[] getErrors() {
        return errors;
    }
     ...
     * @param errors
     */
    public void setErrors(com.sforce.soap.enterprise.SendEmailError[] errors) {
        this.errors = errors;
    }

    public com.sforce.soap.enterprise.SendEmailError getErrors(int i) {
        return this.errors[i];
    }

    public void setErrors(int i, com.sforce.soap.enterprise.SendEmailError _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "SendEmailResult"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("errors");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "errors"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "SendEmailError"));
