...
public class DescribeLayoutResult  implements java.io.Serializable {
    private com.sforce.soap.enterprise.DescribeLayout[] layouts;

    private com.sforce.soap.enterprise.RecordTypeMapping[] recordTypeMappings;
    ...
    public DescribeLayoutResult(
           com.sforce.soap.enterprise.DescribeLayout[] layouts,
           com.sforce.soap.enterprise.RecordTypeMapping[] recordTypeMappings,
    ...
    public com.sforce.soap.enterprise.DescribeLayout getLayouts(int i) {
        return this.layouts[i];
    }

    public void setLayouts(int i, com.sforce.soap.enterprise.DescribeLayout _value) {
    ...
    public com.sforce.soap.enterprise.RecordTypeMapping getRecordTypeMappings(int i) {
        return this.recordTypeMappings[i];
    }

    public void setRecordTypeMappings(int i, com.sforce.soap.enterprise.RecordTypeMapping _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeLayoutResult"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("layouts");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "layouts"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeLayout"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("recordTypeMappings");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "recordTypeMappings"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "RecordTypeMapping"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "recordTypeSelectorRequired"));
