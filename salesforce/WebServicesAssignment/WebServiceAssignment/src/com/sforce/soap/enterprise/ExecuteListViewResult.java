...
public class ExecuteListViewResult  implements java.io.Serializable {
    private com.sforce.soap.enterprise.ListViewColumn[] columns;
    ...
    private com.sforce.soap.enterprise.ListViewRecordColumn[][] records;
    ...
    public ExecuteListViewResult(
           com.sforce.soap.enterprise.ListViewColumn[] columns,
           java.lang.String developerName,
           boolean done,
           java.lang.String id,
           java.lang.String label,
           com.sforce.soap.enterprise.ListViewRecordColumn[][] records,
           int size) {
    ...
    public com.sforce.soap.enterprise.ListViewColumn getColumns(int i) {
        return this.columns[i];
    }

    public void setColumns(int i, com.sforce.soap.enterprise.ListViewColumn _value) {
     ...
     * @return records
     */
    public com.sforce.soap.enterprise.ListViewRecordColumn[][] getRecords() {
        return records;
    }
     ...
     * @param records
     */
    public void setRecords(com.sforce.soap.enterprise.ListViewRecordColumn[][] records) {
        this.records = records;
    }

    public com.sforce.soap.enterprise.ListViewRecordColumn[] getRecords(int i) {
        return this.records[i];
    }

    public void setRecords(int i, com.sforce.soap.enterprise.ListViewRecordColumn[] _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "ExecuteListViewResult"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("columns");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "columns"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "ListViewColumn"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("developerName");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "developerName"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("done");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "done"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "records"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "ListViewRecord"));
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("size");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "size"));
