...
public class DescribeSoftphoneLayoutSection  implements java.io.Serializable {
    ...
    private com.sforce.soap.enterprise.DescribeSoftphoneLayoutItem[] items;
    ...
    public DescribeSoftphoneLayoutSection(
           ...
           com.sforce.soap.enterprise.DescribeSoftphoneLayoutItem[] items) {
    ...
    public com.sforce.soap.enterprise.DescribeSoftphoneLayoutItem getItems(int i) {
        return this.items[i];
    }

    public void setItems(int i, com.sforce.soap.enterprise.DescribeSoftphoneLayoutItem _value) {
        this.items[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeSoftphoneLayoutSection"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("entityApiName");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "entityApiName"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("items");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "items"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeSoftphoneLayoutItem"));
        elemField.setNillable(false);
