...
public class ResetPasswordResponse  implements java.io.Serializable {
    private com.sforce.soap.enterprise.ResetPasswordResult result;

    public ResetPasswordResponse() {
    }

    public ResetPasswordResponse(
           com.sforce.soap.enterprise.ResetPasswordResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.sforce.soap.enterprise.ResetPasswordResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.sforce.soap.enterprise.ResetPasswordResult result) {
        this.result = result;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", ">resetPasswordResponse"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("result");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "result"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "ResetPasswordResult"));
