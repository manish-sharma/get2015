...
public class DescribeDataCategoryGroupStructures  implements java.io.Serializable {
    private com.sforce.soap.enterprise.DataCategoryGroupSobjectTypePair[] pairs;
    ...
    public com.sforce.soap.enterprise.DataCategoryGroupSobjectTypePair getPairs(int i) {
        return this.pairs[i];
    }

    public void setPairs(int i, com.sforce.soap.enterprise.DataCategoryGroupSobjectTypePair _value) {
        this.pairs[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", ">describeDataCategoryGroupStructures"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("pairs");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "pairs"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DataCategoryGroupSobjectTypePair"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("topCategoriesOnly");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "topCategoriesOnly"));
