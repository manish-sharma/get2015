...
public class SoqlConditionGroup  extends com.sforce.soap.enterprise.SoqlWhereCondition  implements java.io.Serializable {
    private com.sforce.soap.enterprise.SoqlWhereCondition[] conditions;
    ...
    public SoqlConditionGroup(
           com.sforce.soap.enterprise.SoqlWhereCondition[] conditions,
           com.sforce.soap.enterprise.SoqlConjunction conjunction) {
    ...
    public com.sforce.soap.enterprise.SoqlWhereCondition getConditions(int i) {
        return this.conditions[i];
    }

    public void setConditions(int i, com.sforce.soap.enterprise.SoqlWhereCondition _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "SoqlConditionGroup"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("conditions");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "conditions"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "conjunction"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "soqlConjunction"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
    }
