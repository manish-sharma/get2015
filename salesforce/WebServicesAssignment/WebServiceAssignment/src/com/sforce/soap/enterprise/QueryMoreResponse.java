...
public class QueryMoreResponse  implements java.io.Serializable {
    private com.sforce.soap.enterprise.QueryResult result;

    public QueryMoreResponse() {
    }

    public QueryMoreResponse(
           com.sforce.soap.enterprise.QueryResult result) {
           this.result = result;
    }
     ...
     * @return result
     */
    public com.sforce.soap.enterprise.QueryResult getResult() {
        return result;
    }
     ...
     * @param result
     */
    public void setResult(com.sforce.soap.enterprise.QueryResult result) {
        this.result = result;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", ">queryMoreResponse"));
