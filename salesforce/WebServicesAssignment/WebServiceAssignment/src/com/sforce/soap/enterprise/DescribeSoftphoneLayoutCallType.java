...
public class DescribeSoftphoneLayoutCallType  implements java.io.Serializable {
    private com.sforce.soap.enterprise.DescribeSoftphoneLayoutInfoField[] infoFields;

    private java.lang.String name;

    private com.sforce.soap.enterprise.DescribeSoftphoneScreenPopOption[] screenPopOptions;

    private java.lang.String screenPopsOpenWithin;

    private com.sforce.soap.enterprise.DescribeSoftphoneLayoutSection[] sections;

    public DescribeSoftphoneLayoutCallType() {
    }

    public DescribeSoftphoneLayoutCallType(
           com.sforce.soap.enterprise.DescribeSoftphoneLayoutInfoField[] infoFields,
           java.lang.String name,
           com.sforce.soap.enterprise.DescribeSoftphoneScreenPopOption[] screenPopOptions,
           java.lang.String screenPopsOpenWithin,
           com.sforce.soap.enterprise.DescribeSoftphoneLayoutSection[] sections) {
    ...
    public com.sforce.soap.enterprise.DescribeSoftphoneLayoutInfoField getInfoFields(int i) {
        return this.infoFields[i];
    }

    public void setInfoFields(int i, com.sforce.soap.enterprise.DescribeSoftphoneLayoutInfoField _value) {
    ...
    public com.sforce.soap.enterprise.DescribeSoftphoneScreenPopOption getScreenPopOptions(int i) {
        return this.screenPopOptions[i];
    }

    public void setScreenPopOptions(int i, com.sforce.soap.enterprise.DescribeSoftphoneScreenPopOption _value) {
    ...
    public com.sforce.soap.enterprise.DescribeSoftphoneLayoutSection getSections(int i) {
        return this.sections[i];
    }

    public void setSections(int i, com.sforce.soap.enterprise.DescribeSoftphoneLayoutSection _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeSoftphoneLayoutCallType"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("infoFields");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "infoFields"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeSoftphoneLayoutInfoField"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "screenPopOptions"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeSoftphoneScreenPopOption"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "screenPopsOpenWithin"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "sections"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeSoftphoneLayoutSection"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
