...
public class DescribeTabSetResult  implements java.io.Serializable {
    ...
    private com.sforce.soap.enterprise.DescribeTab[] tabs;
    ...
    public DescribeTabSetResult(
           ...
           com.sforce.soap.enterprise.DescribeTab[] tabs) {
    ...
    public com.sforce.soap.enterprise.DescribeTab getTabs(int i) {
        return this.tabs[i];
    }

    public void setTabs(int i, com.sforce.soap.enterprise.DescribeTab _value) {
        this.tabs[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeTabSetResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "logoUrl"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("namespace");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "namespace"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "selected"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "boolean"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("tabSetId");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "tabSetId"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(false);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("tabs");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "tabs"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "DescribeTab"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
