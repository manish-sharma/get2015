...
public class SearchSnippet  implements java.io.Serializable {
    ...
    private com.sforce.soap.enterprise.NameValuePair[] wholeFields;
    ...
    public SearchSnippet(
           ...
           com.sforce.soap.enterprise.NameValuePair[] wholeFields) {
           this.text = text;
    ...
    public com.sforce.soap.enterprise.NameValuePair getWholeFields(int i) {
        return this.wholeFields[i];
    }

    public void setWholeFields(int i, com.sforce.soap.enterprise.NameValuePair _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "SearchSnippet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("text");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "text"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "wholeFields"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "NameValuePair"));
        elemField.setMinOccurs(0);
