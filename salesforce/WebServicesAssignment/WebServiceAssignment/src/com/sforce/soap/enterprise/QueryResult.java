...
public class QueryResult  implements java.io.Serializable {
    ...
    private com.sforce.soap.enterprise.sobject.SObject[] records;
    ...
    public QueryResult(
           ...
           com.sforce.soap.enterprise.sobject.SObject[] records,
           int size) {
           this.done = done;
    ...
    public com.sforce.soap.enterprise.sobject.SObject getRecords(int i) {
        return this.records[i];
    }

    public void setRecords(int i, com.sforce.soap.enterprise.sobject.SObject _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "QueryResult"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "queryLocator"));
