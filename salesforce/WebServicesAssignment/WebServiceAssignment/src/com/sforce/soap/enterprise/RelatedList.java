...
public class RelatedList  implements java.io.Serializable {
    ...
    private com.sforce.soap.enterprise.DescribeLayoutButton[] buttons;

    private com.sforce.soap.enterprise.RelatedListColumn[] columns;
    ...
    private com.sforce.soap.enterprise.RelatedListSort[] sort;

    public RelatedList() {
    }

    public RelatedList(
           com.sforce.soap.enterprise.ShareAccessLevel accessLevelRequiredForCreate,
           com.sforce.soap.enterprise.DescribeLayoutButton[] buttons,
           com.sforce.soap.enterprise.RelatedListColumn[] columns,
           boolean custom,
           ...
           com.sforce.soap.enterprise.RelatedListSort[] sort) {
    ...
    public com.sforce.soap.enterprise.DescribeLayoutButton getButtons(int i) {
        return this.buttons[i];
    }

    public void setButtons(int i, com.sforce.soap.enterprise.DescribeLayoutButton _value) {
    ...
    public com.sforce.soap.enterprise.RelatedListColumn getColumns(int i) {
        return this.columns[i];
    }

    public void setColumns(int i, com.sforce.soap.enterprise.RelatedListColumn _value) {
    ...
    public com.sforce.soap.enterprise.RelatedListSort getSort(int i) {
        return this.sort[i];
    }

    public void setSort(int i, com.sforce.soap.enterprise.RelatedListSort _value) {
        this.sort[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "RelatedList"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("accessLevelRequiredForCreate");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "accessLevelRequiredForCreate"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "buttons"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "columns"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "RelatedListColumn"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "field"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "limitRows"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "sobject"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://www.w3.org/2001/XMLSchema", "string"));
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("sort");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "sort"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:enterprise.soap.sforce.com", "RelatedListSort"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
        elemField.setMaxOccursUnbounded(true);
        typeDesc.addFieldDesc(elemField);
