...
public class largestDigitInNumberTest {
	...
	public void largestDigittest1() {
		...
		int actualLargestDigit=objectOflargestDigitNumber.getlargestdigit(2);
	...
	public void largestDigittest2() {
		...
		int actualLargestDigit=objectOflargestDigitNumber.getlargestdigit(1257369);
		assertEquals("Match",expectedLargestDigit,actualLargestDigit);
	...
	public void largestDigittest3() {
		...
		int actualLargestDigit=objectOflargestDigitNumber.getlargestdigit(444);
		assertEquals("Match",expectedLargestDigit,actualLargestDigit);
