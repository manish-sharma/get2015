	...
	public static void main(String args[]) {
		try {
			...
			BufferedReader br = new BufferedReader(new InputStreamReader(
					System.in));
			PrintQuestion object1 = new PrintQuestion();
			...
			do {
				...
				case 1:
					...
					result = scan.nextInt();
					if (result < 0 || result > 5) { // to check for correct
													// input for single select
					...
					System.out.println(object1.multipleSelect()); // to check
																	// for
																	// correct
																	// input of
																	// multi
