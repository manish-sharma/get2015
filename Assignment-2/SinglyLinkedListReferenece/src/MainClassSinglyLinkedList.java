...
public class MainClassSinglyLinkedList 
{
	...
	public static void main(String []args)
	{
		...
		do 
		{
			...
			switch(choice) {
			case 1:
				singlyLinkedList.createList(start);
				break;
			case 2:
			...
			case 6:
				System.out.print("Enter Number");
				value = scanner.nextInt();
				singlyLinkedList.deleteElementByValue(start, value);
				break;
			case 7:
				System.out.print("Enter Index: ");
				value = scanner.nextInt();
				singlyLinkedList.deleteElementByIndex(start, value);
				break;
			case 8: 
				singlyLinkedList.reverseList(start);
				break;
			case 9:
