...
<link rel="styleSheet" href="/Case-Study-5/css files/CreateCarStyle.css">
...
<body>
	<div class="wrapper">
		...
		<header>
			<img src="/Case-Study-5/images/logo.png" alt="car dekho logo" width="400px"
	...
	<section>
		...
		<form name="createCarForm"  method="post" action="/Case-Study-5/CreateCarController">
