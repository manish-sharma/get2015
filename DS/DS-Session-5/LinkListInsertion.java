...
public class LinkListInsertion {
	...
	//This method insert an element into the list after sorting
	public Node recursiveOrderedInsert(int item)
	{   sortList();
		return recursiveInsert(first, item);
	}
	
	//This method recursively add element into the already sorted list
	public Node recursiveInsert(Node head, int val)
	{   
	    //special case: first item is null
	    if (head==null)
	    {
	        head = createNode(val);
	    ...
	    //base case
	    if ( (head.next!=null) &&  (head.next.item > val ) )
	    {
	    ...
	    return recursiveInsert(head.next, val);
	}
	...
	public static void main(String [] arg) {
		...
		LinkListInsertion obj = new LinkListInsertion();
