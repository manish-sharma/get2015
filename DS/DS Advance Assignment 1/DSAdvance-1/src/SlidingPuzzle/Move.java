...
public class Move {
	...
	/**
	 * Returns a new state with the blank space swapped with the tile above it.
	 * 
	 * @param state
	 *            The state being operated on.
	...
	/**
	 * Returns a new state with the blank space swapped with the tile below it.
	 * 
	 * @param state
	 *            The state being operated on.
	 * @return null if the state is invalid, the new state if valid.
	...
	/**
	 * Returns a new state with the blank space swapped with the tile to the
	 * left of it.
	 * 
	 * @param state
	 *            The state being operated on.
