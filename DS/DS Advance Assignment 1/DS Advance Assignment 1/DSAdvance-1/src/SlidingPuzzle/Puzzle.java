...
/**
 * This class contains logic and properties that are related to a sliding
 * puzzle.
 *
 *
 */
public class Puzzle {
	 ...
	 *            Valid sliding puzzle in 2D array format.
	 * @param outFile
	 *            A filename to output solution to.
	 */
	...
	/**
	 * This method checks whether or not the puzzle object it is called on is a
	 * solvable puzzle or not.
	 * 
	...
	/**
	 * This method determines whether or not the data inputted by the user is a
	 * valid puzzle format.
	 * 
	 * @param puzzleInput
	...
	/**
	 * This method retrieves a user's input from the console and returns the
	...
	/**
	 * This method retrieves a user's input from a file and returns the input as
	 * an integer array.
	 * 
	 * @param filename
	 *            - The filename to retrieve from.
	 */
	...
	/**
	 * This method replaces blanks in the user's input with 0s for easier
	 * solving of the puzzle.
	 * 
	 * @param row
	 *            The row input by the user.
	...
	/**
	 * This method converts a string of user's input into an integer array to be
	 * used by the puzzle class.
	 * 
	 * @param s
	 *            A string of 9 integers separated by spaces.
	...
	/**
	 * This method calculates the current heuristic for a puzzle's state. The
	 * heuristic it uses is the sum of the Manhattan Distance of each tile from
	 * where it is located to where is should be.
	 * 
	 * @param array
	 *            A puzzle state array.
	...
	/**
	 * This method calculates the Manhattan Distance between a tile's location
	 * and it's goal location.
	 * 
	 * @param index
	 *            The tile's current index.
	 * @param number
