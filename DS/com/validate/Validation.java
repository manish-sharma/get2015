 ...
 * @name Validation
 * @description this class will validate the input expression 
 */
...
public class Validation {
	/**
	 * @name isExpression()
	 * @description this method will validate the input infix expression
	 * @param expression
	 *            (boolean expression in infix notation)
	 * @return
	 */
