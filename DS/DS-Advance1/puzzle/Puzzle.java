...
public class Puzzle {
	...
	public final PriorityQueue < State > queue = new PriorityQueue < State > (CAPACITY, new Comparator < State > () {@Override
	...
	public static int[] getConsoleInput() {
		System.out.println("\nEnter a valid 8-puzzle below:");@SuppressWarnings("resource")
	...
	public static int getHeuristic(int[] array) {
		...
		for (int i = 0; i < array.length; i++) {
			if (array[i] != 0) heuristic += getManhattanDistance(i, array[i]);
		}
		return heuristic;
	}
