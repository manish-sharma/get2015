...
/**
 * ArrayList1 class is used to make different different operations in list 1
 * @default size default size of list1
 * @size initializes with zero
 * @data generic data to make array list
...
public class ArrayList1 {
	...
	/**
	 * this method is used to add elements in the list1
	...
	/**
	 * this method is used to add element at particular index
	 ...
	 */
	 ...
	 /**
	  * this method is retrieve the first occuerence of the value at the given position
	  * @param position from where the occurence is to be find
	  * @param value 
 ...
 */
	 ...
	 /**
	  * this method is used to remove element at particular position
	  * @param position at which element is to removed
	  */
