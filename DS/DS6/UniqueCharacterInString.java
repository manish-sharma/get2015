...
public class UniqueCharacterInString {
	...
	/**this function used to insert characters of a string in a set, so that no repetition of character can occur
	 * @param string
	...
	/**this function is used to  calculate the unique character occurrence in string
	 * @param string
	 */
	public static void calculateUniqueCharacterOccerence(String string) {
		string = string.toLowerCase();
		if (stringMap.containsKey(string))
			System.out.println("we have already that string so unique charater in that string is -> "+ stringMap.get(string));
		else
