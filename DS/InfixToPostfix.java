...
public class InfixToPostfix {
	...
	/**
	 * purpose : to get the priority of operator
	...
	/**
	 * purpose : to check that current character is operand or not
	...
	/**
	 * purpose: to check current character is operator or not
	 * @param c = current character
	 * @return true if operand,otherwise false
	 */
	...
	/**
	 * purpose: to convert infix into post fix
