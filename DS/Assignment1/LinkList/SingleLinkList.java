...
/**this class holds the function of link list
 * @author Khemanshu
 *
 */
public class SingleLinkList {
	 ...
	 */
	public void addItemInLinkList(int value) {
	 ...
	 */
	public void addItemAtPosition(int position, int value) {
		Node newNode = new Node(value, null);
		Node temp = start;
		if(position>size)
		{	
	 ...
	 * @param value
	 */
	public void removeItemOntheBasedOfValue(int value) {
		Node temp = start;
		Node previous = temp;
