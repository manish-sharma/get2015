...
public class ArrayList {
	...
	/* Start of mergeList function */
	int []mergeList(ArrayList arrayList) {		//it will merge two list
		int sizeOfArray1 = this.array.length - 1;
		int sizeOfArray2 = this.array.length - 1;
		int []mergedList = new int[sizeOfArray + sizeOfArray +1 ] ;
		for(int count = 0 ; count < sizeOfArray1 ; count ++) {
			mergedList [ count ] = this.array[ count ] ;
		}
		for(int count = 0 ; count < sizeOfArray2 ; count++) {
			mergedList [ count + sizeOfArray1 ] = this.array[ count ] ;
		}
		return mergedList;
	}
	/*End of mergeList function */
}
