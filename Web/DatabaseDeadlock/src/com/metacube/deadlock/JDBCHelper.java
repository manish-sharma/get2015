...
public class JDBCHelper {
	...
	public void deadlock1() {
		...
		try {
			...
			String query1 = "UPDATE Customer SET first_name = 'sumi' WHERE customer_id=1";
			stmt = con.createStatement();
			stmt.executeUpdate(query1);
			//now put transaction one in waiting state
			String query3 = "select SLEEP(5) ";
			stmt = con.createStatement();
	...
	public void deadlock2() {
		...
		try {
			...
			String query2 = "UPDATE Orders SET order_name = 'abcd' WHERE order_id = 1";
			stmt = con.createStatement();
			...
			String query4 = "UPDATE customer SET first_name = 'efgh' WHERE customer_id=1";
			stmt = con.createStatement();
			stmt.executeUpdate(query4);
