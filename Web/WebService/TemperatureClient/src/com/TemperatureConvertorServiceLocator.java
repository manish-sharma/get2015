...
public class TemperatureConvertorServiceLocator extends org.apache.axis.client.Service implements com.TemperatureConvertorService {
    ...
    private java.lang.String TemperatureConvertor_address = "http://localhost:8080/WebServiceAssignment/services/TemperatureConvertor";
    ...
    public com.TemperatureConvertor getTemperatureConvertor() throws javax.xml.rpc.ServiceException {
    ...
    public com.TemperatureConvertor getTemperatureConvertor(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.TemperatureConvertorSoapBindingStub _stub = new com.TemperatureConvertorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.TemperatureConvertor.class.isAssignableFrom(serviceEndpointInterface)) {
                com.TemperatureConvertorSoapBindingStub _stub = new com.TemperatureConvertorSoapBindingStub(new java.net.URL(TemperatureConvertor_address), this);
                _stub.setPortName(getTemperatureConvertorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://com", "TemperatureConvertorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://com", "TemperatureConvertor"));
        }
