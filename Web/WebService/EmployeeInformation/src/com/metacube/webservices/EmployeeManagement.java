...
public class EmployeeManagement {
	//http://localhost:8080/Employee_Information/rest/employeemanagement/create
	...
	//http://localhost:8080/Employee_Information/rest/employeemanagement/id/1
	@Path("id/{id : \\d+}")
	@GET
	@Produces("application/xml")
	...
	//http://localhost:8080/Employee_Information/rest/employeemanagement/name/nikhil tinkar
	@Path("name/{name}")
	@GET
	@Produces("application/xml")
	...
	//http://localhost:8080/Employee_Information/rest/employeemanagement/employees
	@Path("/employees")
	@GET
	@Produces("application/xml")
