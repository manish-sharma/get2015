...
CREATE TABLE `car` (
  ...
  `has_ac` varchar(5) NOT NULL DEFAULT 'No',
  `power_steering` varchar(10) NOT NULL DEFAULT 'Normal',
  `has_accessory_kit` varchar(5) NOT NULL DEFAULT 'No',
  `vehicle_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`car_id`),
  KEY `fk_car_id` (`vehicle_id`),
...
INSERT INTO `car` VALUES (1,'Yes','Normal','Yes',8);
