...
public class TemperatureConverterServiceLocator extends org.apache.axis.client.Service implements com.webservices.TemperatureConverterService {
    ...
    private java.lang.String TemperatureConverter_address = "http://localhost:8080/WebServiceAssignment1/services/TemperatureConverter";
    ...
    public com.webservices.TemperatureConverter getTemperatureConverter() throws javax.xml.rpc.ServiceException {
    ...
    public com.webservices.TemperatureConverter getTemperatureConverter(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.webservices.TemperatureConverterSoapBindingStub _stub = new com.webservices.TemperatureConverterSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.webservices.TemperatureConverter.class.isAssignableFrom(serviceEndpointInterface)) {
                com.webservices.TemperatureConverterSoapBindingStub _stub = new com.webservices.TemperatureConverterSoapBindingStub(new java.net.URL(TemperatureConverter_address), this);
                _stub.setPortName(getTemperatureConverterWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.com", "TemperatureConverterService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.com", "TemperatureConverter"));
        }
