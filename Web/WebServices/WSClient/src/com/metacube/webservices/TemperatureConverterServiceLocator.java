...
public class TemperatureConverterServiceLocator extends org.apache.axis.client.Service implements com.metacube.webservices.TemperatureConverterService {
    ...
    private java.lang.String TemperatureConverter_address = "http://localhost:8080/SOAPTemperatureConverter/services/TemperatureConverter";
    ...
    public com.metacube.webservices.TemperatureConverter getTemperatureConverter() throws javax.xml.rpc.ServiceException {
    ...
    public com.metacube.webservices.TemperatureConverter getTemperatureConverter(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacube.webservices.TemperatureConverterSoapBindingStub _stub = new com.metacube.webservices.TemperatureConverterSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacube.webservices.TemperatureConverter.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacube.webservices.TemperatureConverterSoapBindingStub _stub = new com.metacube.webservices.TemperatureConverterSoapBindingStub(new java.net.URL(TemperatureConverter_address), this);
                _stub.setPortName(getTemperatureConverterWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.metacube.com", "TemperatureConverterService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.metacube.com", "TemperatureConverter"));
        }
