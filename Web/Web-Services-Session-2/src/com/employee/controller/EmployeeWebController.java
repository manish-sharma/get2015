...
public class EmployeeWebController
{
	 ...
	 * @param id
	 * @return
	 * Description: Retrieves the Information of the employee By Id
	 **/
	@GET
	@Path("/id/{id : \\d+}")
	...
	public String retrieveEmployeeById(@PathParam("id") int id) 
	{
		...
		try
		{
			// Retrieving the information of the Employee Id
	...
	public String retrieveAllEmployeesByName(@PathParam("name") String name) 
	{
		...
		try 
		{
			// Object of employee Retrieve All Employee By Name
