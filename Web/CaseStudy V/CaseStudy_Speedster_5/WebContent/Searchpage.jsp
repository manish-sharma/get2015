...
<body>
	...
	<div id="container">
		<input id="toggle" type="checkbox"> <label id="menu_button" for="toggle">=</label>
	...
	<form action="SearchPageController" method="post">
		<div class='search'>
			<h2>Search</h2>
		<div class="searchOptions">
			<input id='filter' name="filter" type="radio" value="byBudget" onclick=search(this.value)>&nbsp;&nbsp;&nbsp;&nbsp;By Budget&nbsp;&nbsp;&nbsp;&nbsp; 
			<input id='filter' name="filter" type='radio' value="byBrand" onclick=search(this.value)>&nbsp;&nbsp;&nbsp;&nbsp;By Brand
		</div>
			<br> <br> 
