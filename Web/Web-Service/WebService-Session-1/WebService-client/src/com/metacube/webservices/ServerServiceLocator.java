...
public class ServerServiceLocator extends org.apache.axis.client.Service implements com.metacube.webservices.ServerService {
    ...
    private java.lang.String Server_address = "http://localhost:8080/WebService-Assignment-1/services/Server";
    ...
    public com.metacube.webservices.Server getServer(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.metacube.webservices.ServerSoapBindingStub _stub = new com.metacube.webservices.ServerSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.metacube.webservices.Server.class.isAssignableFrom(serviceEndpointInterface)) {
                com.metacube.webservices.ServerSoapBindingStub _stub = new com.metacube.webservices.ServerSoapBindingStub(new java.net.URL(Server_address), this);
                _stub.setPortName(getServerWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.metacube.com", "ServerService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.metacube.com", "Server"));
        }
