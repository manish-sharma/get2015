 ...
 * @since  02/11/2015
 * 
 * it will handle all operation related to employee creation,retrieve,deletion and produces output in XML format
 */
...
public class EmployeeWebController {
	 ...
	 * it will create an employee by further calling the method
	...
	/**
	 * 
	 *  it will retrieve an employee by id by further calling the
	...
	/**
	 * 
	 * it will retrieve all employees by name by further calling
	...
	/**
	 * 
	 *it will retrieve all employees by further calling the method
	...
	/**
	 * 
	 *  it will delete an employee by id by further calling the
