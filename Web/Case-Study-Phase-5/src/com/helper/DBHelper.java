...
public class DBHelper {
		 ...
		 */
		public static List<Car> queryToFetchAllCarDetails(Connection connection) {
		...
		public static boolean isLogInCorrect(Connection connection,String userName,String password) {
		...
		public static int addInformation(Connection connection, Vehicle vehicle,Car car) throws CarDekhoSystemException{
			int flag = 0;
			...
			try {
				...
				preparedStatement.setLong(10, onRoadPrice);
				 ...
				 if(flag != 0){
					 flag = addInformationCar(connection, car,vehicleId);
				 }
			}catch (SQLException e) {
		...
		public static int addInformationCar(Connection connection,Car car, int id)throws CarDekhoSystemException {
			int flag = 0;
		...
		public static boolean addUser(Connection connection, String id, String password) {
			PreparedStatement ps = null;
		...
		public static List<Vehicle> searchByMakeAndModel(Connection connection ,Vehicle vehicle , Car car) throws CarDekhoSystemException , CarDekhoCarAlreadyExistException{
			
			String query = "SELECT * FROM vehicle WHERE make = '"+car.getMake()+"' AND model = '"+car.getModel()+"'";
		...
		public static List<Car> searchById(Connection connection ,int id)throws CarDekhoSystemException {
		...
		public static int updateByModel(Connection connection,Vehicle vehicle,Car car, int id)throws CarDekhoSystemException {
			int isUpdate =0;
			...
			try {
				...
				preparedStatement.setInt(10, id);
				 ...
				 if(isUpdate != 0){
					 isUpdate = updateCar( connection,car,id);
				 }
			} catch (SQLException e) {
				e.printStackTrace();
			} finally {
		...
		private static int updateCar(Connection connection,Car car,int id) {
			int isUpdate =0;
		...
		public static List<Vehicle> searchByMakeAndModel1(Connection connection,
