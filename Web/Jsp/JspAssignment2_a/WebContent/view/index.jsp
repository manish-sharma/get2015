			...
			<form action="../Registration" name="myform">
				<table>
					<tr>
						...
						<td><input id="fName" name="firstName" type="text" placeholder="Enter Name here" /></td>
					</tr>
					<tr>
						<td><span>*</span> Last Name : </td>
						<td><input type="text" placeholder="Enter Last Name" id="lName" name="lName"/></td>
					</tr>
					<tr>
						<td><span>*</span> Email : </td>
						<td><input type="text" placeholder="Enter email" id="email" name="eMailID"/></td>
					</tr>
					<tr>
