...
public class Main {
	...
	public static void main(String[] args) {
		...
		employee1.setEmployeeName("Anjita");
		employee1.setEmployeeId(101);
		employee1.setCtcPerAnnum(100000000);
		employee1.setDateOfBirth("08/03/1995");
		employee1.setEmailId("am@gmail.com");
		employee1.setDateOfJoining("03/08/2015");
		System.out.println(employee1.toString());
		String json = "{\"employeeId\":101,\"emailId\":\"am@gmail.com\",\"dateOfBirth\":\"08/03/1995\",\"dateOfJoining\":\"03/08/2015\",\"ctcPerAnnum\":1.0E8,\"employeeName\":\"Anjita\"}";
		Employee employee2;
