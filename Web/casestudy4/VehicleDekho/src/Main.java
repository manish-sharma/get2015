...
public class Main {
	...
	public static void main(String args[]) {
		try
		{
		    ...
		    List<Vehicle> vehicleList = readVehicleData.readConfig("C:/Users/Khemanshu/CaseStudy/VehicleDekho/VehicleData.xml");
		    Iterator<Vehicle> vehicleIterator = vehicleList.iterator();
		    Connection connection = ConnectionFactory.getConnection();
		    while(vehicleIterator.hasNext()) {
		    	System.out.println("Hello");
		    	VehicleJDBCHelper.insert(connection, vehicleIterator.next());
		    }
		}
		catch(Exception e) {
