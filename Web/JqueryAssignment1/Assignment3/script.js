 ...
 */
function selectOne() {
	$('span.message').css('background-color','blue');
}
 ...
 */
function selectTwo() {
	 $( 'div.box:first' ).css('background-color','blue');
}
 ...
 */
function selectFour() {
	 $('input[type="image"][alt="hello"]').css('width','300px');
}
 ...
 */
function selectFive() {
	$( '#myDiv' ).find('input[type="text"]').css('background-color','blue');
}
 ...
 */
function selectSix() {
	$( 'input[type="text"][name^="txt"]' ).css('background-color','blue');
}
...
function selectSeven() {
	$( 'p:not(".box")' ).css('background-color','blue');
}
...
function selectEight() {
	 $( 'div.box, div.error' ).css('background-color','blue');
}
 ...
 */
function selectNine() {
	$( 'div.box.error' ).css('background-color','blue');
}
 ...
 */
function selectTen() {
	$( '#myDiv' ).find('span.info').css('background-color','blue');
}
