...
public class TemperatureConvertorServiceLocator extends org.apache.axis.client.Service implements com.meta.webservices.TemperatureConvertorService {
    ...
    private java.lang.String TemperatureConvertor_address = "http://localhost:8080/WSAssignment_1/services/TemperatureConvertor";
    ...
    public com.meta.webservices.TemperatureConvertor getTemperatureConvertor() throws javax.xml.rpc.ServiceException {
    ...
    public com.meta.webservices.TemperatureConvertor getTemperatureConvertor(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.meta.webservices.TemperatureConvertorSoapBindingStub _stub = new com.meta.webservices.TemperatureConvertorSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.meta.webservices.TemperatureConvertor.class.isAssignableFrom(serviceEndpointInterface)) {
                com.meta.webservices.TemperatureConvertorSoapBindingStub _stub = new com.meta.webservices.TemperatureConvertorSoapBindingStub(new java.net.URL(TemperatureConvertor_address), this);
                _stub.setPortName(getTemperatureConvertorWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.meta.com", "TemperatureConvertorService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.meta.com", "TemperatureConvertor"));
        }
